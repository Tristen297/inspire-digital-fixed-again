    ...
    return(
        <div className="services-breakdown-content">
            ...
            <div className="services-breakdown-text">
                ...
                <p>
                    That's why we offer a better option: a $150 monthly retainer that covers development and ongoing services which would typically cost extra at a traditional agency. Plus, you can cancel anytime with no hassle if it's not the right fit.
                </p>
            </div>
